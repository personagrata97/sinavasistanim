...
let clean = raw.replace(/Bu bölüm, .*? basit ve net bir sözlüktür\..*?aşağıda bulabilirsiniz\./g, "Bu bölümde, müfredatta yer alan teknik kısaltmalar ve terimler listelenmektedir.");
