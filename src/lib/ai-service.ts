...
3. ⚠️ KESİN KURAL: Asla ama asla "Harika bir görev", "İşte notlar", "İşte cilalanmış versiyon" gibi sohbet, giriş veya kapanış cümleleri yazma! "Cilaladım", "düzenledim" gibi raporlamalar KESİNLİKLE YASAKTIR. Doğrudan Markdown içeriği ile başla (örn: '## 📌 Başlık'). Sadece saf ders notu çıktısı ver.
